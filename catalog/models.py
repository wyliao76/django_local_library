...
import datetime
from catalog.language import Lang
...
class Author(models.Model):
    ...
    date_of_death = models.DateField('Died', null=True, blank=True, help_text='Date format: yyyy-mm-dd')
...
class Profile(models.Model):
    ...
    portrait = models.FileField(upload_to='media/', blank=True)
